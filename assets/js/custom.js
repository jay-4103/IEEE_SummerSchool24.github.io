(function($) {
    ...
    (function init() {
        function getTimeRemaining(endtime) {
            var now = new Date();
            var t = Date.parse(endtime) - now.getTime();
            console.log("Current time: " + now.toISOString());
            console.log("End time: " + endtime);
            console.log("Time remaining in milliseconds: " + t);
        ...
        // Use ISO 8601 format for UTC: YYYY-MM-DDTHH:MM:SSZ
        initializeClock("2024-08-04T00:00:00Z");
    })();
